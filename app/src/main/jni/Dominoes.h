...
jmethodID jmethod_playSound;
jmethodID jmethod_showDeleteButton;
jmethodID jmethod_hideDeleteButton;
jmethodID jmethod_enableStartButton;
jmethodID jmethod_disableStartButton; 
jmethodID jmethod_toggleStartButton;
...
bool shouldClearSelectedDomino;
